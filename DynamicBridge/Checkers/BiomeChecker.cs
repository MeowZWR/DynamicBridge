...
namespace DynamicBridge.Core
{
    public static class BiomeChecker
    {
        ...
        {
            [Biome.沙漠] = [TerritoryRegion.GyrAbania, TerritoryRegion.Thanalan],
            [Biome.热带] = [TerritoryRegion.LaNoscea, TerritoryRegion.Othard, TerritoryRegion.Ilsabard],
            [Biome.温带] = [TerritoryRegion.TheBlackShroud, TerritoryRegion.MorDhona, TerritoryRegion.Norvrandt, TerritoryRegion.TheWorldUnsundered,],
            [Biome.针叶林] = [TerritoryRegion.AbalanthiasSpine, TerritoryRegion.Dravania,],
            [Biome.苔原] = [TerritoryRegion.Coerthas],
            [Biome.荒原] = [TerritoryRegion.TheNorthernEmpty, TerritoryRegion.TheHighSeas,],
            [Biome.城市热岛] = [TerritoryRegion.TheHighSeas,],
            [Biome.城市] = [TerritoryRegion.Hingashi],
        };
