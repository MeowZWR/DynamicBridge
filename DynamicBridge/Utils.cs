...
namespace DynamicBridge
{
    public static unsafe class Utils
    {
        ...
        public static string GetHouseDefaultName()
        {
            ...
            return $"{Svc.Data.GetExcelSheet<TerritoryType>().GetRowOrDefault(Svc.ClientState.TerritoryType)?.PlaceNameRegion.ValueNullable?.Name.ExtractText()}，第{h->GetCurrentWard() + 1}区，{h->GetCurrentPlot() + 1}号";
        }
